...
public abstract class Hahmo {
    ...
    /*
     *  Hahmon kokoa ei huomioida liikkumistoiminnossa, jolloin 
     *  hahmon x- tai y-koordinaatti voi olla ulkona ruudusta, vaikka osa hahmosta
     *  olisi vielä näkyvissä. Tähän löytyy — mahdollisesti — ratkaisu 
     *  Node-luokalta löytyvästä getBoundsInParent-metodista.
     */
    public void liiku() {
